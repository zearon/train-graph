...
public class ActionFactory {
	 ...
	 */
	public static UIAction createDirectAction(String actionDesc, Runnable action0) {
	 ...
	 * @return The DirectAction created and executed
	 */
	public static <T1> UIAction createDirectAction(String actionDesc, 
	 ...
	 * @return The DirectAction created and executed
	 */
	public static <T1, T2> UIAction createDirectAction(String actionDesc, 
	 ...
	 * @return The DirectAction created and executed
	 */
	public static <T1, T2, T3> UIAction createDirectAction(String actionDesc, 
	 ...
	 * @return The DirectAction created and executed
	 */
	public static <T1, T2, T3, T4> UIAction createDirectAction(String actionDesc, 
	 ...
	 */
	public static UIAction createTableCellEditAction(String tableName,
	...
	/**
	 * Create a TableElementMoveAction.
	...
	public static UIAction createTableElementMoveAction(
	...
	/**
	 * Create a TableElementMoveAction. After the table element is moved,
	...
	public static UIAction createTableCellIncrementAction(
	...
	/**
	 * Create a SetValueAction. After the value is set,
	 * do an extra call back action.
	 ...
	 * @return The created and executed TableElementMoveAction object.
	 */
	public static <T> UIAction createSetValueAction(String valueDesc,
	...
	public static <T> UIAction createSetListElementAction(String valueDesc, 
			List<T> list, List<T> listElements, Runnable callback) {

		UIAction action = new SetListElementAction<T>(valueDesc, list, 
				listElements, callback);

		return action;
	}

	/**
	 * Create a RevertRaillineAction. 
	 ...
	 */
	public static UIAction createRevertRaillineAction(JTable table,
	...
	/**
	 * Create a AddTableElementAction. After a new element is added,
	 * do an extra call back action.
	 ...
	 */
	public static <T> UIAction createAddTableElementAction(
	...
	/**
	 * Create a AddTableElementsAction. After a new element is added,
	 * do an extra call back action.
	 * A AddTableElementsAction represents an action that adds several elements into a JTable.
	 * @param tableName A name used to describe the table being modified.
	 * @param table The JTable object being modified.
	 * @param vertical True if add a row ; False if add a column.
	 * @param index The new row/column index of the element to be inserted.
	 * @param elements The elements in type of T[] to be inserted.
	 * @param adder A add function in type of BiConsumer<Integer, T> that add a new element of
	 * type T into the underlying data model in a specific position as the first argument indicates.
	 * <br/>If the underlying data model is a Vector, then <b>add</b> method of the vector
	 * should be used.
	 ...
	 * @return The created and executed AddTableElementAction object.
	 */
	public static <T> UIAction createAddTableElementsAction(
			String tableName, JTable table, boolean vertical, int index,
			T[] elements, BiConsumer<Integer, T> adder, Consumer<Integer> remover,
			Runnable callback) {

		UIAction action = new AddTableElementsAction<T>(tableName, table,
				vertical, index, elements, adder, remover, callback);
	...
	/**
	 * Create a RemoveTableElementAction. After the elements are removed,
	 * do an extra call back action.
	 ...
	 */
	public static <T> UIAction createRemoveTableElementsAction(String tableName,
		...
		UIAction action = new RemoveTableElementsAction<>(tableName, table,
	...
	/**
	 * Create a TableRowColumnIncrementAction.
	 ...
	 */
	public static UIAction createTableRowColumnIncrementAction(
	...
	public static <T, P> UIAction createCreateNewTrainRouteSectionAction(
			String actionDesc, JTable table, int index, T element,
			BiConsumer<Integer, T> adder, Consumer<Integer> remover,
			P oldValue, P newValue, Consumer<P> valueSetter, Runnable callback) {
		
		UIAction action = new CreateNewTrainRouteSectionAction(actionDesc,
				table, false, index, element, adder, remover,
				oldValue, newValue, valueSetter, callback);
		
		return action;
	}
	
	public static UIAction createPasteTrainRouteSectionAction(String actionDesc, 
			JTable table, int index, TrainRouteSection[] trains,
			BiConsumer<Integer, TrainRouteSection> adder, Consumer<Integer> remover,
			PasteParameters oldValue, PasteParameters newValue, 
			Consumer<PasteParameters> valueSetter, Runnable callback) {
		
		UIAction action = new PasteTrainRouteSectionAction(actionDesc, table,
				false, index, trains, adder, remover, oldValue, newValue,
				valueSetter, callback);
		
		return action;
	}
	
//	public static UIAction createCompoundAction(Runnable callback,
//			String actionDesc, UIAction... actionArray) {
//
//		UIAction action = new CompoundAction(callback, actionDesc, actionArray);
//		action.setActionDone(true);
//
//		return action;
//	}
//	
//	public static UIAction createCompoundActionByReplacement(Runnable callback,
//			String actionDesc, UIAction... actionArray) {
//
//		UIAction action = new CompoundAction(callback, actionDesc, actionArray);
//		action.setActionDone(true);
//
//		ActionManager.getInstance().replaceActions(Arrays.asList(actionArray), action);
//		
//		if (callback != null)
//			callback.run();
//
