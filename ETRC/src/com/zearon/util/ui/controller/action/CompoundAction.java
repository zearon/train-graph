...
public class CompoundAction extends UIAction {
	...
	public CompoundAction(Runnable callback, String actionDesc, UIAction... actionArray) {
		this.actions = Arrays.asList(actionArray);
		this.actionDesc = actionDesc;
		this.callback = callback;
	}

	public CompoundAction(Runnable callback, String actionDesc, List<UIAction> actionList) {
