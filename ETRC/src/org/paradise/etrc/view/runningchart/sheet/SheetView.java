...
public class SheetView extends JPanel {
	...
	RunningChartView runningChartView;
...
//private ChartSettings settings;
	...
	public SheetView(TrainGraph trainGraph, RunningChartView runningChartView) {
		this.runningChartView = runningChartView;
		
		setModel(trainGraph);

		table = new SheetTable(__("timetable"), this, runningChartView);
