...
import org.paradise.etrc.util.ui.widget.TransparentComponent;
import org.paradise.etrc.util.ui.widget.TransparentLabel;
import org.paradise.etrc.util.ui.widget.ZoomSlider;
...
//		bgScrollPane.setViewportView(mapPanel);
		...
		if (trainGraph != null) {
			GLWindow mapCanvas = GLWindow.create(ETRC.getInstance().glcaps);
