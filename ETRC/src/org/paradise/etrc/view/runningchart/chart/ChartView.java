...
import org.paradise.etrc.view.runningchart.chart.traindrawing.DrawingModel;
...
//	Vector<TrainDrawing> underDrawings  = new Vector<TrainDrawing>();
	...
	public ChartView(TrainGraph trainGraph, RunningChartView runningChartView) {
		...
		panelLines = new LinesPanel(trainGraph, this, runningChartView);
...
//	}
	...
	public void setActiveTrain(Train train) {
		...
		if (activeTrain != null) {
//			MainFrame.getInstance().setActiceTrainName(activeTrain.getTrainName(trainGraph.currentLineChart.railroadLine));
			//打开ToolTip
			panelLines.setToolTipText("");
		} else {
//			MainFrame.getInstance().setActiceTrainName("");
			//关闭ToolTip
...
//		int m = time.getMinutes();
	...
	public void updateUpDownDisplay() {
		...
		runningChartView.updateUpDownDisplay(showUpDownState);
	...
	public void setCoordinateCorner(Point p) {
		...
		cornerCoordinate.setText("(" + getClockString(minutes) + ","
				+ getDistString(dist) + ")");
		runningChartView.setViewStatus(trainGraph.currentLineChart.railroadLine.getStationName(dist, true));
	}
...
//	}
	...
	public void setActiveStation(Station station) {
		...
		repaint();
		runningChartView.getSheetView().selectStation(station);
	}
	...
	public void addTrain(Train train) {
		...
		runningChartView.getSheetView().updateData();
