...
public class DirectAction extends UIAction {
	...
	public DirectAction(String actionDesc, Runnable action) {
		this.actionDesc = actionDesc;
		this.action = action;
	}
	public <T1> DirectAction(String actionDesc, Consumer<T1> action, T1 a) {
		this.actionDesc = actionDesc;
		this.action = () -> action.accept(a);
	}
	public <T1, T2> DirectAction(String actionDesc, 
			BiConsumer<T1, T2> action, T1 a1, T2 a2) {
		this.actionDesc = actionDesc;
		this.action = () -> action.accept(a1, a2);
	}
	public <T1, T2, T3> DirectAction(String actionDesc, 
			TriConsumer<T1, T2, T3> action, T1 a1, T2 a2, T3 a3) {
		this.actionDesc = actionDesc;
		this.action = () -> action.accept(a1, a2, a3);
	}
	public <T1, T2, T3, T4> DirectAction(String actionDesc, 
