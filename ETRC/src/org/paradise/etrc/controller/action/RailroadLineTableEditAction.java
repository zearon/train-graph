...
public class RailroadLineTableEditAction extends TableEditAction {

	RailroadLineTableEditAction(JTable table,
			DefaultJEditTableModel tableModel, int row, int column,
			Object newValue) {

		super("railroad line", table, tableModel, row, column, newValue);
	}
}
